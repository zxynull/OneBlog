<div class="col-sm-3 blog-sidebar">
    ...
    <#else>
        <div class="sidebar-module" style="position: relative;">
            <a href='https://www.baidu.com' target="_blank" rel="external nofollow"><img src='https://gitee.com/yadong.zhang/DBlog/widgets/widget_1.svg?color=07b83f' alt='About me on Baidu' style="position: absolute;right: 0;"/></a>
