    ...
    <div class="container">
        <div class="row">
            <div class="col col-xs-12 col-md-12 col-lg-12">
                ...
                <p><#if config.copyright!>${config.copyright} |</#if> Powered by <a href="www.baidu.com" title="个人博客系统...欢迎浏览" data-toggle="tooltip" data-placement="right" target="_blank"><i>浩瀚新宇</i></a>  </p>
                <#if url?? && (url == "index")>
